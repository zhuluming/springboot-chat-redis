...
public interface JurisdictionDao {
     ...
     *
     * @param entities List<Jurisdiction> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<Jurisdiction> entities);
     ...
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<Jurisdiction> entities);
